...
| 61 | both `arxiv_bundles/*/SUBMIT.md` | abstract paste still said "18-script battery"; provenance line cited "entries 42-45" | "19-script battery"; "entries 42-70" | **[FIXED]** |
| 62 | `ACTION_PLAN.md:13` | "18 Python scripts = code of record" | 19 (incl. `boson_scaling_probe.py`) | **[FIXED]** |
| 63 | `README.md:45,47,49` | "29-entry discrepancy catalog"; "audit history, Phase 1-6"; "(18 .py)" | "70-entry"; "Phase 1-8.3"; "(19 .py)" | **[FIXED]** |
