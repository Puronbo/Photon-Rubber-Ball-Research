...
or any other scripts (emoji‑free version for Windows consoles).
...
Usage
-----
$ python ai_script_manager_noemoji.py
    # or make it executable: chmod +x ai_script_manager_noemoji.py && ./ai_script_manager_noemoji.py
"""
