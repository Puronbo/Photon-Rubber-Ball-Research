...
| `results_of_record.py` | **added 2026-09-24** — single-command reproduction gate: 45 asserts (checks 17-27 add the rank-degree ladder, counting substrate π(10⁷)/twins + composite-majority theorem, unbounded prime-free runs witness, small-factor dominance, filled light-cone 3-ball volume 3.568e80 m³, doubling 1,2,4,8, i-period, Euler; checks 28-35 add the register self-consistency CI, ball rest energy E=mc² = 8.612 J, Schwarzschild radius 1.423e-43 m, full 18-rung ladder matrix, ladder gap moments, H0-band observable ball 4.06e26–4.4e26 m, two-observer overlap 63.28%, Bekenstein bound 4.71e20 k_B, Heegner run tables; check 36 adds the zero-framework cone/scale/closure kernel: balanced r=z ⇒ θ=π/4, scaling alone never fixes the angle, qⁿ→0, prime scales 1/p, 2π closure; checks 37-38 RESOLVE the framework's two open problems: X27 independence of c under minimal axioms A–G, X28 topological Π vs metric-dependent π; checks 39-40 close Part XVI's remaining symbols: N and p need not be prime — any m is a period of some F and composite q are legal — and the relations do not fix the geometry, one C8 graph carrying chord metrics that scale with the free radius ρ; checks 41-42 audit the axiom set (E and G vacuous as written) and test it against the corpus ladder, which violates E with 0 of 17 prime-reciprocal steps; checks 43-44 add the sourced pulsar and quasar rungs and reproduce the PSR B1929+10 spin-down triad and the J0341+1720 / J2125-1719 Eddington ratios to 1.2% and 0.36%), exit 0 |
...
└─ "Law Apprehension of Works/"             separate essay/proposal thread [PLANNING];
     ├─ 24 tracked .md: analyses + framework + PRESENTATION_OUTLINE + 2026-09-25
