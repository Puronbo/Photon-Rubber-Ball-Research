...
| `results_of_record.py` | **added 2026-09-24** — single-command reproduction gate: 26 asserts (checks 17-26 add the rank-degree ladder, counting substrate π(10⁷)/twins + composite-majority theorem, unbounded prime-free runs witness, small-factor dominance, doubling 1,2,4,8, i-period, Euler), exit 0 |
