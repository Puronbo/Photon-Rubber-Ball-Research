...
```bash
python results_of_record.py      # 42 checks, exit 0
```
...
│  │                                      CORRIGENDUM.md (96-entry catalog, 1 [FALSE], n [FIXED])
...
└─ Law Apprehension of Works/              planning thread (informational, NOT physics):
       ...
       LAW_OF_CENTER_ASCENT.md (law-craft, postulates flagged REAL vs POSTULATE)
        ...
        FORMAL_AXIOMS_ZEROS.md (minimal axiom skeleton A–G; X27/X28 resolved, checks 37-38; N/p not forced, geometry not fixed, checks 39-40; E/G vacuous as stated, ladder violates E, checks 41-42)
