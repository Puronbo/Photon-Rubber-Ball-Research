...
- Canonical numbers are reproducible with one command: `python results_of_record.py` (40 checks, exit 0).
...
|---|---|---|
| 1.1 `results_of_record.py` reproduces + asserts the canonical table | 40/40 checks, exit 0 | DONE |
