...
- Canonical numbers are reproducible with one command: `python results_of_record.py` (24 checks, exit 0).
...
|---|---|---|
| 1.1 `results_of_record.py` reproduces + asserts the canonical table | 24/24 checks, exit 0 | DONE |
