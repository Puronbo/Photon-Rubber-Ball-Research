...
a 16-rung length/scale ladder with a gate script reproducing every asserted
...
(\texttt{results\_of\_record.py}, 36 checks, exit 0). The speculative framing
...
\subsection{The 16-rung scale ladder}
...
The log10 gaps of this ladder are all distinct (0.51--15.79, mean 4.095,
sd 3.926) — descriptive, not a significance claim.
